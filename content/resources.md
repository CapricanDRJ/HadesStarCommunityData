...
<div class="resource-links" style="display: flex; flex-wrap: wrap; gap: 1rem;">
  ...
  <a class="resource-card" href="https://blackstarorder.org/" target="_blank" rel="noopener" style="display: flex; align-items: center; text-decoration: none; background: #1a1a1a; border: 1px solid #444; padding: 0.5rem 1rem; border-radius: 6px; transition: box-shadow 0.2s;">
    <img src="https://ws.tsl.rocks/corp/e75857448fb1e8d620c964ec4abe23f7e07374a4a70fde79f655862152e8f428/favicon.png" alt="Hades Space" style="width: 16px; height: 16px; margin-right: 0.5rem;">
    <span style="color: #ddd;">BlackStar Order</span>
  </a>
