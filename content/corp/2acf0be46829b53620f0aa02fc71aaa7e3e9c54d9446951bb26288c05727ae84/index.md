...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let timestamps = [1753335554,1752878178,1752378227,1751910369,1751457235,1751001714,1750523935];
...
<div>
  Last updated: <span class="last-updated-date" data-unix-time="1753767554"></span>
</div>