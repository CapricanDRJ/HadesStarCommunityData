...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>We're an enduring community, looking for new and active players. We offer experienced mentors on hand to help with regular WS and RS runs. Use of Discord is highly recommend https://discord.gg/n4nHC3N</body></html>"></iframe>
