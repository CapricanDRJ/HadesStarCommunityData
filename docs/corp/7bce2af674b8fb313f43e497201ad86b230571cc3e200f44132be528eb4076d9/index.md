...
layout: page
title: ​Zvezdec
description: W:39 L:19 D:0 Bonus ✅
image: ./favicon.png
date: 1733123896
---
<head>
...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>Мы не проигрываем на бз. Почти. Зайди, проверь. We don't  lose a game. Телеграмм      https://t.me/Nebula_Zvezdec            Участие в бз обязательно.</body></html>"></iframe>
