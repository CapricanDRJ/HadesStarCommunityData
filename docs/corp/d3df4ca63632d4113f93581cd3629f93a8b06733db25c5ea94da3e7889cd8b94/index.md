...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>Member of Hades Federation- GalaxyGirl's orig msg: Anybody can join, but no being mean and excluding... Aires adds: (unless in a blue star :) &lt;-- evil smile White/red star battling galore Dis:Rp9mSNP</body></html>"></iframe>
