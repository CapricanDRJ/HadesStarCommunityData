...
layout: page
title: ​BRASIL STAR
description: W:43 L:18 D:3 Bonus ✅
image: ./favicon.png
date: 1732994995
---
<head>
...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>Bem vindo à BRASIL STAR &lt;br&gt;&lt;br&gt;Estrelas Vermelhas (RS) e Estrelas Brancas (WS) coordenadas pelo WhatsApp, peça para te adicionarem no grupo no chat da corporação :D</body></html>"></iframe>
