...
```
    ...
    <b><span style="color:#00FF9F;">Λ<span style="color:yellow;">V</span></span><span style="color:white;">梨山养老院</span></b>欢迎各位大佬及萌新加入养老,神器福利全送出!r4r5神器颜色任选！<size=100><span style="color:yellow;">允许捐旗舰!</span></size>              创立于8月1日
    </div>
    {:/}
