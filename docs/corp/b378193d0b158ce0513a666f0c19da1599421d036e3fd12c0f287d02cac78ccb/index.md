...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>Welcome to the SGC.  White Star scanners turned on at WS search requires active participation or you will be kicked from the corp.  Turn OFF WS scanner if unable to participate.</body></html>"></iframe>

### Whitestar Bonus ❌

| Statistic | Value |
| --- | --- |
| ELO Regular | 1094 🔻  (1253)|
| ELO Competitive | 1103 🔻  (1292)|
| Total Matches | 9 |
| Wins | 0 |
| Losses | 8 |
| Draws | 1 |
