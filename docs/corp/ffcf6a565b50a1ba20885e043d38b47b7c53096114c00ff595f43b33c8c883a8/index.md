...
<iframe style="display:block;border:none;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:transparent;color:inherit;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:inherit;background-color:transparent;}</style></head><body>1. If you leave the game or stop playing for 14 days please advise by general chat. 2. Verbal abuse is not allowed. 3. I will be connected every day making adjustments to the clan.</body></html>"></iframe>
