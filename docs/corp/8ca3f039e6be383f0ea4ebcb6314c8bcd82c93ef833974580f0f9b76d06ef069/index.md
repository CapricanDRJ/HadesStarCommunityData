...
```
    ...
    <iframe style="display:block;border:1px solid #ccc;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;" srcdoc="<!DOCTYPE html><html><head><style>body{all:initial;font-family:Arial,sans-serif;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;}</style></head><body>Welcome to KINETIC! A corporation almost as old as the Hades universe itself! Currently open to anyone looking to learn and grow together. 100+ White Star wins and powerful allies!</body></html>"></iframe>
