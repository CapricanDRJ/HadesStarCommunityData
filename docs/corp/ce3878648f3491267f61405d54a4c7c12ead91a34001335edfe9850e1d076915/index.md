...
```
 Be nice and be active, we will support you on your way up :) https://discord.com/invite/3z6EWUq5
```

    <iframe style="display:block;border:1px solid #ccc;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;" srcdoc="<!DOCTYPE html><html><head><style>body{all:initial;font-family:Arial,sans-serif;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;}</style></head><body>Be nice and be active, we will support you on your way up :) https://discord.com/invite/3z6EWUq5</body></html>"></iframe>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let timestamps = [1702756801,1702243774];
