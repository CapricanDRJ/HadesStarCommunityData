...
layout: page
title: ​Crux Cadre
description: W:35 L:30 D:1 Bonus ✅
image: ./favicon.png
date: 1732770213
---
<head>
...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>Want to grow? Run White Stars? Have fun and mix with a friendly competitive crew? We got you covered! We welcome all level players, so come run with us! Say hi on Discord!</body></html>"></iframe>
