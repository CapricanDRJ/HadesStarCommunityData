...
```
 Deutschsprachiger Konzern sucht aktive Spieler mit Interesse an RR und WZ. Spaß am Spiel steht bei uns im Vordergrund, Hilfe bei Rrs immer gegeben, Wz meist wöchentlich 
```

    <iframe style="display:block;border:1px solid #ccc;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;" srcdoc="<!DOCTYPE html><html><head><style>body{all:initial;font-family:Arial,sans-serif;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;}</style></head><body>Deutschsprachiger Konzern sucht aktive Spieler mit Interesse an RR und WZ. Spaß am Spiel steht bei uns im Vordergrund, Hilfe bei Rrs immer gegeben, Wz meist wöchentlich </body></html>"></iframe>

### Whitestar Bonus ❌

| Statistic | Value |
| --- | --- |
| ELO Regular | 1016 🔻  (1314)|
| ELO Competitive | 1031 🔻  (1330)|
| Total Matches | 18 |
| Wins | 0 |
| Losses | 18 |
| Draws | 0 |
