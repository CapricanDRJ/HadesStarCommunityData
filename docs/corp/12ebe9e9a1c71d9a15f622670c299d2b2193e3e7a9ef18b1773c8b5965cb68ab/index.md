...
<iframe style="display:block;border:none;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:transparent;color:inherit;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:inherit;background-color:transparent;}</style></head><body><span style=&quot;color:"red";&quot;>Goonies Never Say Die</span> We're active (give or take a few members), organised (just check our WS wins yo!) & friendly (y’all come back)Alliance with: 7SinS, Galaxia. Discord Require</body></html>"></iframe>
