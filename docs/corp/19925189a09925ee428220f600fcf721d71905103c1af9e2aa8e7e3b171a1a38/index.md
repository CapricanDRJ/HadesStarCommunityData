...
layout: page
title: ​First Legion
description: W:43 L:48 D:1 Bonus ❌
image: ./favicon.png
date: 1732577909
---
<head>
...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>leave no man behind! join and we'll share the  fights!&lt;br&gt;Coordinate Red Star battles, with GMT. Weekly WS starting on wednesdays.&lt;br&gt;&lt;br&gt;Sister corporations: TeddisaurusWrex, Armored Union</body></html>"></iframe>
