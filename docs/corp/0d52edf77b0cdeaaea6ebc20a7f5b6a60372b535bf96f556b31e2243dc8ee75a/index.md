...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>We are an English-speaking community founded on the ideals of democracy and camaraderie. 

Weekly competitive WS; casual WS if numbers allow. 

Discord is required.</body></html>"></iframe>
...
| Statistic | Value |
| --- | --- |
| ELO Regular | 1326 🔻  (113)|
| ELO Competitive | 1382 🔻  (147)|
| Total Matches | 62 |
| Wins | 37 |
| Losses | 25 |
| Draws | 0 |
