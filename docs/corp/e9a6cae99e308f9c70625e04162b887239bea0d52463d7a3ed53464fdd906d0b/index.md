...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>Competitive white star corp, back to back WS, daily RS, artifact exchange, <span style=&quot;color:red;&quot;>WS no peace only war :) </span>Recruiting now</body></html>"></iframe>
...
| Statistic | Value |
| --- | --- |
| ELO Regular | 1030 🔻  (1308)|
| ELO Competitive | 1052 🔻  (1325)|
| Total Matches | 17 |
| Wins | 0 |
| Losses | 17 |
| Draws | 0 |
