...
layout: page
title: ​Hun Generals
description: W:11 L:63 D:0 Bonus ❌
image: ./favicon.png
date: 1733062898
---
<head>
...
<iframe style="display:block;border:1px solid #444;border-radius:5px;width:100%;max-width:800px;height:auto;overflow:hidden;margin:1em 0;background-color:#2d2d2d;color:#f8f8f2;" srcdoc="<!DOCTYPE html><html><head><style>body{all:unset;line-height:1.5;white-space:pre-wrap;margin:0;padding:10px;color:#f8f8f2;background-color:#2d2d2d;font-family:monospace;}</style></head><body>Magyarok ide. A szabályok egyszerűek: napi aktivitás, segítsd a társaidat. WS-ezés feltétele a discord.</body></html>"></iframe>

### Whitestar Bonus ❌

| Statistic | Value |
| --- | --- |
| ELO Regular | 901 🔻  (1332)|
| ELO Competitive | 1105 🔻  (1289)|
| Total Matches | 74 |
| Wins | 11 |
| Losses | 63 |
| Draws | 0 |
